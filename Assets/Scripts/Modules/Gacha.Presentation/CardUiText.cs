    ...
    public static class CardUiText
    {
        ...
        public static readonly IReadOnlyDictionary<string, string> EnglishFallbacks =
            new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["settings.experience.sound"] = "Sound cues",
                ["settings.experience.reduce_motion"] = "Reduce motion",
                ["settings.experience.haptics"] = "Haptics",
                ["settings.experience.animation_speed"] = "Animation speed",
                ["settings.experience.sound_on"] = "On",
                ["settings.experience.muted"] = "Muted",
                ["settings.experience.on"] = "On",
                ["settings.experience.off"] = "Off",
                ["settings.experience.auto_save"] = "Changes save automatically.",
                ["settings.experience.saved"] = "Saved automatically.",
                ...
                ["settings.diagnostics.title"] = "Local data and diagnostics",
                ["settings.diagnostics.description"] = "Redacted diagnostics stay on this device. You decide when to export or clear them.",
                ["settings.diagnostics.summary"] = "{0} files · {1} used · kept up to {2} days / {3}. No automatic upload.",
                ["settings.diagnostics.save_protection.available"] = "Automatic local save is available.",
                ["settings.diagnostics.save_protection.active"] = "Save protection is active. Automatic overwrite stays off until recovery succeeds.",
                ["settings.diagnostics.action.export"] = "Export diagnostics",
                ["settings.diagnostics.action.clear"] = "Clear diagnostics",
                ["settings.diagnostics.status.ready"] = "Only controlled, redacted diagnostic logs are included.",
                ["settings.diagnostics.status.exported_safe"] = "Redacted diagnostics exported.",
                ["settings.diagnostics.status.cleared"] = "Local diagnostic logs cleared.",
                ["settings.diagnostics.status.cancelled"] = "Diagnostic export cancelled.",
                ["settings.diagnostics.status.error_safe"] = "Diagnostics could not continue. Your saves and settings were not changed.",
                ["settings.diagnostics.confirm.title"] = "Clear local diagnostics?",
                ["settings.diagnostics.confirm.body"] = "This permanently deletes controlled diagnostic logs on this device. Cards, saves, settings, and downloaded content are not changed.",
